...
export function noMatchValidator(fieldName: string) {
    let fcfirst: FormControl;
    let fcSecond: FormControl;

    return function noMatchValidator(control: FormControl) {
        ...
        if (!fcfirst) {
            ...
            //FormControl Second
            if (!fcSecond) {
                throw new Error('noMatchValidator(): Second control is not found in the parent group!');
            }
